...
let num = parseInt(prompt("Ingrese un número para verificar se es multiplo de 5: ")) ;

if (num % 5 === 0 ) {
	console.log("Si el número" + num + "si es mutiplo de 5");
} else {
	console.log("No el número" + num + "no es mutiplo de 5")
}
